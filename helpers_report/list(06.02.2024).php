...
<script type="text/javascript">
	...
	function get_filter_list(country_id, state_id, district_id, city_id, area_id, help_type, blood_id) {
		jQuery.ajax({
			...
			data: "country_id=" + country_id + "&state_id=" + state_id + "&district_id=" + district_id + "&city_id=" + city_id + "&area_id=" + area_id + "&help_type=" + help_type+"&blood_id="+blood_id,
			success: function(msg) {
	...
	function helpers_report_overall_print(country_id, state_id, district_id, city_id, area_id, help_type, blood_id) {
        ...
        window.open('helpers_report/helpers_report_overall_print.php?country_id=' + country_id + '&state_id=' + state_id + '&district_id=' + district_id + '&city_id=' + city_id + '&area_id=' + area_id + "&help_type=" + help_type +"&blood_id="+blood_id+ "&dash_country_id=" + dash_country_id + "&dash_state_id=" + dash_state_id + "&dash_district_id=" + dash_district_id + "&dash_city_id=" + dash_city_id + "&dash_area_id=" + dash_area_id, 'onmouseover', 'height=650,width=950,scrollbars=yes,resizable=no,left=250,top=250,toolbar=no,location=no,directories=no,status=no,menubar=no');
		/*jQuery.ajax({
			type: "POST",
