...
$user_type_query = $_REQUEST['user_type_query'];
...
?>
<?php
$survey = $pdo_conn->prepare("SELECT * FROM helpers_details WHERE helpers_details_id!='' $user_type_query $query ORDER BY helpers_details_id ASC");
$survey->execute();
