<script language="javascript" type="text/javascript" src="userrights/userrights.js"></script>
	...
	<section class="content-header report-pg" style="background-repeat: no-repeat;background-position: center;background-size: cover;background-image: url(images/top_bg.png);padding: 4px 30px;">
	  ...
	  <div class="col-md-6">
		...
		<div class="col-md-6">
		<div class="btn-add"><a href="index.php?file=userrights/create" >Add New</a></div>
		</div>
      </h1>	  
    </section>
    <!-- Main content -->
							...
							<table id="example" class="table table-bordered table-hover table-striped display nowrap margin-top-10 w-p100">
								...
								<tbody>
									...
									{ 
										...
										$pdo_userroll = $pdo_conn->prepare("SELECT * FROM userformrights WHERE delete_status !='1' and  userroll_id ='".$value['userroll_id']."' and delete_status !='1'");
