...
<table style="margin-left:20px" width="100%">
    <tr>
        ...
        <td rowspan="5" height="200"><?php if($record['image']==""){
    ...
    <tr>
        <td colspan="2">Blood Group :  <?php echo $record['blood_group']; ?></td>
    </tr>
    <tr>
...
<table width="100%" style="margin-left:20px">
    <tr>
        <td width="80%">இரத்த தானம் செய்ய நான் தயார் (இரத்த வகை: <?php echo $record['blood_group']; ?>)</td>
        <td width="20%"><?php if (in_array("donate_blood", $service)) { echo "Yes"; } else { echo "No"; } ?></td>
    </tr>
    <tr>
        ...
        <td><?php if (in_array("donate_food", $service)) { echo "Yes"; } else { echo "No"; } ?></td>
    </tr>
    <tr>
        <td>வேறுயாரவது அன்புச்சோறு சமைத்து வழங்கினால் தினசரி ஏழையின் வீடு தேடி எடுத்து சென்று வழங்க தயார்.</td>
        <td><?php if (in_array("serve_food", $service)) { echo "Yes"; } else { echo "No"; } ?></td>
    </tr>
    <tr>
        <td>உழைக்க இயலாத குடும்பங்களுக்கு மாதந்தோறும் உணவு வழங்க நான் தயார்.</td>
        <td><?php if (in_array("monthly_food", $service)) { echo "Yes"; } else { echo "No"; } ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><?php if (in_array("free_tuition", $service)) { echo "Yes"; } else { echo "No"; } ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><?php if (in_array("grow_trees", $service)) { echo "Yes"; } else { echo "No"; } ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><?php if (in_array("sell_products", $service)) { echo "Yes"; } else { echo "No"; } ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><?php if (in_array("sponsors", $service)) { echo "Yes"; } else { echo "No"; } ?></td>
    </tr>
    <tr>
        ...
        <td><?php if (in_array("public", $service)) { echo "Yes"; } else { echo "No"; } ?></td>
    </tr>
    <tr>
        <td>விளையாட்டுப் பயிற்சி மற்றும் உடற்பயிற்சி வழங்க நான் தயார்.</td>
        <td><?php if (in_array("sports", $service)) { echo "Yes"; } else { echo "No"; } ?></td>
    </tr>
    <tr>
        <td>MSK வின் அனைத்து பணிகளும் வெற்றி பெறுவதற்கு பிராத்தனை செய்ய நான் தயார்.</td>
        <td><?php if (in_array("prayer", $service)) { echo "Yes"; } else { echo "No"; } ?></td>
    </tr>
    <tr>
