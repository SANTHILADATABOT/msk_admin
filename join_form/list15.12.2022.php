...
{ //alert("join_id"+join_id);
	jQuery.ajax({
	type: "POST",
	url: "join_form/view.php?",
	data: "join_id="+join_id,
	success: function(msg)
	{ 
	 // $("#quotation_view_modal_body").html(msg);
	 window.open('join_form/view.php?join_id='+join_id,'onmouseover','height=650,width=950,scrollbars=yes,resizable=no,left=250,top=250,toolbar=no,location=no,directories=no,status=no,menubar=no');	
	}
	});
}
