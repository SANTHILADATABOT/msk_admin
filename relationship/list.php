    ...
    <section class="content-header report-pg" style="background-repeat: no-repeat;background-position: center;background-size: cover;background-image: url(images/top_bg.png);padding: 4px 30px;">
	  ...
	  <div class="col-md-6">
		...
		<div class="col-md-6">
		<div class="btn-add"><a href="index.php?file=relationship/create" >Add New</a></div>
		</div>
      </h1>	  
    </section>
            ...
            <div class="box-body">
				<div class="table-responsive">               
				  <table id="example" class="table table-bordered table-hover table-striped display nowrap margin-top-10 w-p100">
					...
					<tbody>						
                        <?php foreach($relationship_list as $value){?>
                        
                           <tr>
						    <td><?php echo $roll_id;?></td>
							<td><?php echo $value['relationship_name'];?></td>
							<td><?php echo $value['description'];?></td>
							
                           <td> 
<!--						  <a href="index.php?file=relationship/view&relationship_id=<?php echo $value['relationship_id']?>" title="Edit"><i class="fa fa-eye" aria-hidden="true"></i></a>  
-->						  <a href="index.php?file=relationship/update&relationship_id=<?php echo $value['relationship_id']?>" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>  	
                          <a href="#" onclick="del(<?php echo $value['relationship_id']?>)" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
