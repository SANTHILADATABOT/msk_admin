...
?>
 ...
 //echo "SELECT * FROM medical_help WHERE delete_status!='1' $query ORDER BY medical_help_id DESC";
						 $survey = $pdo_conn->prepare("SELECT * FROM medical_help WHERE delete_status!='1' $query $user_type_query $dash_query ORDER BY medical_help_id DESC");
 $survey->execute();
...
<div id="daybook_report_prints">
	<table width="100%" cellspacing="0" cellpadding="0">
         <tr>
			...
			<td height="37" align="center" class="style5">Medical Help Report</td>
		</tr>
	</table>
	<br>
    <table width="100%" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
			...
			<td width="5%" align="center" class="style10 style4 right"><strong>&nbsp;Age</strong></td>
			<td width="12%" align="center" class="style10 style4 right"><strong>&nbsp;Disease Name</strong></td>
			...
			<td width="14%" align="center" class="style10 style4 right"><strong>&nbsp;Doctor Advise</strong></td>
			<td width="14%" align="center" class="style10 style4 right"><strong>&nbsp;Need Amount - Surgery</strong></td>
...
?>
	...
	<tr>
                ...
                <td align="center" class="style2 right">&nbsp;<?php echo $disease_name; ?></td>
			    <td align="center" class="style2 right">&nbsp;<?php echo $address; ?></td>
		        <td align="center" class="style2 right">&nbsp;<?php echo $mobile_no; ?></td>
			    <td align="center" class="style2 right">&nbsp;<?php echo $doctor_advice; ?></td>
				<td align="center" class="style2 right">&nbsp;<?php echo $need_amt; ?></td>
