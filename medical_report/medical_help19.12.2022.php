...
<?php 
            ...
            <img src="/msk_mobb/img/medical_help/<?php echo $record['image1']; ?>"width="900" height="1300" alt="medical image">   
            ...
            <?php 
				 ...
				 {
			 ?>
            <img src="/msk_mobb/img/medical_help/<?php echo $record['image2']; ?>"width="900" height="1300" alt="medical image">   
            <?php } ?>
            <br><br>
            <?php 
				 if($record['image3']=="")
				 ...
				 {
			 ?>
            <img src="/msk_mobb/img/medical_help/<?php echo $record['image3']; ?>"width="900" height="1300" alt="medical image">   
            <?php } ?>
            <br><br>
            <?php 
				 if($record['image4']=="")
				 ...
				 {
			 ?>
            <img src="/msk_mobb/img/medical_help/<?php echo $record['image4']; ?>"width="900" height="1300" alt="medical image">   
            <?php } ?>
            <br><br>
            <?php 
				 if($record['image5']=="")
				 ...
				 {
			 ?>
            <img src="/msk_mobb/img/medical_help/<?php echo $record['image5']; ?>"width="900" height="1300" alt="medical image">   
            <?php } ?>
