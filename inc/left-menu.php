          ...
          <a href="index.php">
           <i class="fa fa-dashboard icon-1" aria-hidden="true"></i>
            ...
            <!-- <li>
                 <a href="index.php">
                   <div class="menu-info">
                     <h4 class="control-sidebar-subheading"><i class="fa fa-dashboard icon-1" aria-hidden="true"></i>Dashboard</h4>
                   </div>
                  </a> 
            </li>
        -->
          ...
          <ul class="treeview-menu">
            ...
            <li>
                 <a href="index.php?file=medical_report/list">
                   <div class="menu-info">
                     <h4 class="control-sidebar-subheading"><i class="fa fa-dot-circle-o sub-icon"></i>Medical Report</h4>
                   </div>
                  </a> 
            </li>
            <li>
                 <a href="index.php?file=food_needed_report/list">
                   <div class="menu-info">
                     <h4 class="control-sidebar-subheading"><i class="fa fa-dot-circle-o sub-icon"></i>Food Needed Report</h4>
                   </div>
                  </a> 
            </li>
            <li>
                 <a href="index.php?file=admission_card_report/list">
                   <div class="menu-info">
                     <h4 class="control-sidebar-subheading"><i class="fa fa-dot-circle-o sub-icon"></i>Admission Card Report</h4>
                   </div>
                  </a> 
            </li>
            <li>
                 <a href="index.php?file=join_form/list">
                   <div class="menu-info">
                     <h4 class="control-sidebar-subheading"><i class="fa fa-dot-circle-o sub-icon"></i>To Become MSK Activists</h4>
                   </div>
                  </a> 
            </li>
            <li>
                 <a href="index.php?file=matrimonial_report/list">
                   <div class="menu-info">
                     <h4 class="control-sidebar-subheading"><i class="fa fa-dot-circle-o sub-icon"></i>Matrimonial Information Report</h4>
                   </div>
                  </a> 
            </li>
            <li>
                 <a href="index.php?file=jobapplication_report/list">
                   <div class="menu-info">
                     <h4 class="control-sidebar-subheading"><i class="fa fa-dot-circle-o sub-icon"></i>Job Application Report</h4>
                   </div>
                  </a> 
            </li>
          <!--  <li>
