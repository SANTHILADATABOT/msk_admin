    ...
    <section class="content-header report-pg" style="background-repeat: no-repeat;background-position: center;background-size: cover;background-image: url(images/top_bg.png);padding: 4px 30px;">
	  ...
	  <div class="col-md-6">
		...
		<div class="col-md-6">
		<div class="btn-add"><a href="index.php?file=state/create" >Add New</a></div>
		</div>
      </h1>	  
    </section>
...
-->						  <a href="index.php?file=state/update&state_id=<?php echo $value['state_id']?>" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>  	
                          <a href="#" onclick="del(<?php echo $value['state_id']?>)" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
