...
<td>
<!--<td><b>Thanavanthar Name :</b> <?php echo $record['thanavanthar_name'] ?></td>-->
<td><b>Mobile Nuber:</b> <?php echo $record['mobile_no'] ?></td>
...
<td>
<!--<td><b>The Amount of giving :</b> <?php echo $record['amount_of_giving'] ?></td>-->
<td><b>School Name:</b> <?php echo $record['school_name'] ?></td>
...
<td>
<!--<td><b>School Imam Signature :</b> <?php echo $record['school_imam_signature'] ?></td>-->
<td><b>Muttavalli Signature:</b> <?php echo $record['muttavalli_signature'] ?></td>
</td>
</tr>
...
<p style="text-align:center;">
    <div >
         <?php 
					 ...
					 {
						 ?>
    <img src="/msk_mobb/img/Food_Needed_Image/<?php echo $record['image']; ?>"width="auto" height="600" alt="job image"   <?php } ?></div></p>
