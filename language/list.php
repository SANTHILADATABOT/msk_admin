 ...
 <section class="content-header report-pg" style="background-repeat: no-repeat;background-position: center;background-size: cover;background-image: url(images/top_bg.png);padding: 4px 30px;">
	  ...
	  <div class="col-md-6">
		...
		<div class="col-md-6">
		<div class="btn-add"><a href="index.php?file=language/create" >Add New</a></div>
		</div>
      </h1>	  
    </section>
				  ...
				  <table id="example" class="table table-bordered table-hover table-striped display nowrap margin-top-10 w-p100">
					...
					<tbody>						
                        <?php foreach($language_list as $value){?>
                           ...
                           <td> 
<!--						  <a href="index.php?file=language/view&language_id=<?php echo $value['language_id']?>" title="Edit"><i class="fa fa-eye" aria-hidden="true"></i></a>  
-->						  <a href="index.php?file=language/update&language_id=<?php echo $value['language_id']?>" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>  	
                          <a href="#" onclick="del(<?php echo $value['language_id']?>)" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
