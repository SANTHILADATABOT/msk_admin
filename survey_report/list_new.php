...
function get_state_list(country_id)
{
	...
	jQuery.ajax({
	type: "POST",
	url: "survey_report/get_list.php?action=get_state_list",
...
function get_district_list(country_id,state_id)
{
	...
	jQuery.ajax({
	type: "POST",
	url: "survey_report/get_list.php?action=get_district_list",
	data: {"country_id":country_id,"state_id":state_id,"district_id":district_id,"city_id":city_id,"area_id":area_id},
	success: function(msg)
	{ 
	    $("#state_id").html(msg);
...
function get_city_list(country_id,state_id,district_id)
{
	...
	jQuery.ajax({
	type: "POST",
	url: "survey_report/get_list.php?action=get_city_list",
	data: {"country_id":country_id,"state_id":state_id,"district_id":district_id,"city_id":city_id,"area_id":area_id},
	success: function(msg)
	{ 
	    $("#state_id").html(msg);
