        ...
        <div class="col-xl-4 col-md-6 col-12">
          <div class="info-box bg-b-purple6"> <!--7-->
            ...
            <span class="info-box-icon push-bottom">
            	...
            	<div class="info-box-content">
	            	<?php 
	                    $job_application= $pdo_conn->prepare("SELECT * FROM job_application WHERE job_id!=''  ORDER BY job_id DESC");
        ...
        <div class="col-xl-4 col-md-6 col-12">
          <div class="info-box bg-b-purple9"> <!--8-->
            ...
            <span class="info-box-icon push-bottom">
	            ...
	            <div class="info-box-content">
	            	<?php 
	                    $matrimonial_information = $pdo_conn->prepare("SELECT * FROM matrimonial_information WHERE matrimonial_id!=''  ORDER BY matrimonial_id DESC");
        ...
        <div class="col-xl-4 col-md-6 col-12">
          <div class="info-box bg-b-purple15"> <!--16-->
            ...
            <span class="info-box-icon push-bottom">
	            ...
	            <div class="info-box-content">
            	<?php 
            	 	$join_masjith = $pdo_conn->prepare("SELECT * FROM join_masjith WHERE join_id!=''  ORDER BY join_id DESC");
        ...
        <div class="col-xl-4 col-md-6 col-12">
          <div class="info-box bg-b-purple16"> 
            ...
            <span class="info-box-icon push-bottom">
	            ...
	            <div class="info-box-content">
            	<?php 
            	 	$admission_card = $pdo_conn->prepare("SELECT * FROM admission_card WHERE admission_card_id!=''  ORDER BY admission_card_id DESC");
